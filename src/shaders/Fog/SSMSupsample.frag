...
layout (binding = 0) uniform sampler2D currentLevelTex;
layout (binding = 1) uniform sampler2D nextLevelTex; //1 mip level higher, the texture to be upsampled
...
void main()
{
    ...
    vec3 base = texture(currentLevelTex, uv).rgb;
